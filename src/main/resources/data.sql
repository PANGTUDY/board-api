...
INSERT INTO POST(category_id, tags, title, contents, date, writer, likes) VALUES ('1', '자바,Java,팡터디,SPRING', '첫 게시글', '게시글의 내용은 500자로 제한합니다.', '1955-05-19 12:24:40', '제임스 고슬링', 123);
INSERT INTO POST(category_id, tags, title, contents, date, writer, likes) VALUES ('1', '자바,제임스 고슬링', '자바 창시자는 누굴까', '제임스 고슬링은 프로그래밍 언어 ''자바(JAVA)''의 창시자이자 가장 영향력 있는 프로그래머 중 한 사람으로 꼽히는 인물입니다. 자바 이외에도 멀티 프로세서용 유닉스와 컴파일러, 메일 시스템, 데이터 인식 시스템 등을 개발한 바 있습니다.', '1955-05-19 12:24:40', '제임스 고슬링', 123);
INSERT INTO POST(category_id, tags, title, contents, date, writer, likes) VALUES ('1', '아파치,자바,리눅스', '자바 기본 문법', '자바 프로그램은 기본적으로 클래스 구조에서 시작 합니다. 클래스는 객체지향 개념에서 객체를 정의하는 틀로서 많은 객체지향 프로그램 언어의 기본 구조 입니다.', '2021-10-27 12:00:00', '서진하', 2);
INSERT INTO POST(category_id, tags, title, contents, date, writer, likes) VALUES ('1', 'Java,Stream,CompletableFuture', '자바 프로그래밍 기초', '내용3', '2021-10-27 12:00:00', '서진하', 11);
...
INSERT INTO POST(category_id, tags, title, contents, date, writer, likes) VALUES ('3', '팡터디,PANGTUDY', 'Spring 게시판 개발(1)', '화면을 설계합니다.', '2021-10-27 12:00:00', '서진하', 9);
INSERT INTO POST(category_id, tags, title, contents, date, writer, likes) VALUES ('3', 'SPRING', 'Spring 게시판 개발(2)', 'API를 설계합니다.', '2021-11-03 12:00:00', '서진하', 2);
INSERT INTO POST(category_id, tags, title, contents, date, writer, likes) VALUES ('3', 'http,REST,swagger', 'Spring 게시판 개발(3)', '게시판의 주요 기능은 다음과 같습니다.
    ...
    - 검색
    - 북마크 공유
    - 북마크 공유 페이지 : 유저별 크롬 즐겨찾기(북마크) 공유하는 공간', '2021-10-27 12:00:00', '서진하', 100);
